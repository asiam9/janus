...
<feed xmlns="http://www.w3.org/2005/Atom" xmlns:opds="http://opds-spec.org/2010/catalog">
	...
	<entry>
		...
		<link href="./tag_sections.xml?mode=${mode}" type="application/atom+xml;type=feed;profile=opds-catalog"/>
	...
	<entry> 	
		...
		<content type="text">Index of ${category?size} tags by number of books tagged.</content>
		<link href="./tag_list.xml?mode=${mode}&amp;sort=books" type="application/atom+xml;type=feed;profile=opds-catalog"/>
		<link href="" type="image/png" rel="http://opds-spec.org/thumbnail"/>
	</entry>
	...
	<entry> 	
		...
		<id>janus:series:books</id>
		<content type="text">Index of ${category?size} tags by number of series tagged.</content>
		<link href="./tag_list.xml?mode=${mode}&amp;sort=series" type="application/atom+xml;type=feed;profile=opds-catalog"/>
		<link href="" type="image/png" rel="http://opds-spec.org/thumbnail"/>
	</entry>
